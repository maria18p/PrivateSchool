...
// 		case "assign":
// 			const teacherID =
// 				state.pairings[action.payload.pairingIndex].availableTeachers[
// 					action.payload.teacherIndex
// 				]._id;
...
export default function EditLessonsModal(props) {
	...
	const showRoomsSelect = () => {
		...
		return (
			<SelectList data={adaptedData} setSelected={(val) => setRoom(val)} />
		);
	};
