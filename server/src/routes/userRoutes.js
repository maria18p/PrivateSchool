...
// import { getRequestUserSchedule, postRequestUpdateSchedule } from '../middleware/schedule.js';
import {
	getRequestUserChat,
	postCreateMessage,
...
//   return respond(await getRequestUserSchedule(req.query), res);
// });

// Router.post('/updateSchedule', async (req, res) => {
//   return respond(await postRequestUpdateSchedule(req.body), res);
// });
